...
Витягує зі скопійованого тексту вакансії: required skills, nice-to-have,
experience years, education requirement, responsibilities, keywords.
Rule-based, без AI — щоб основний matching-функціонал не залежав від Gemini.
"""
...
def _find_section(text_lower: str, markers: list[str]) -> str | None:
    """Знаходить блок тексту, що йде після одного з маркерів-заголовків, до наступного порожнього рядка х2."""
...
def parse_job_description(raw_text: str) -> dict:
    ...
    # Required = всі знайдені скіли мінус ті, що потрапили в nice-to-have
