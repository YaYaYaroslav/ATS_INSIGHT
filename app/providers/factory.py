...
class NoOpProvider(BaseAIProvider):
    """Використовується, коли AI_PROVIDER=none — застосунок працює без AI (як задумано в архітектурі)."""
...
def get_ai_provider() -> BaseAIProvider:
    """
    Повертає singleton-інстанс поточного AI-провайдера відповідно до
    settings.AI_PROVIDER. Якщо провайдер не вдається ініціалізувати
    (наприклад, немає ключа) — падаємо назад на NoOpProvider, щоб
    решта застосунку продовжувала працювати.
    """
